...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">StudioMedia</a>
            ...
            <div class="row py-5 m-0">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        ...
                        <button class='btn btn-dark'><a class='text-light' value='Continue Shopping' href='./index.php'>Continue Shopping</a>
...
if (isset($_POST['continue_shopping'])) {
    ...
    if (isset($_SESSION['username'])) {
        ...
        if ($cart_count > 0) {
            $total_price = 0;
            $total_products = 0;
            $invoice_number = mt_rand(); // Generate random invoice number
            $order_date = date("Y-m-d H:i:s"); // Current timestamp
            $order_status = 'pending';
            
            // Calculate total price and products
            while ($cart_row = mysqli_fetch_array($run_cart)) {
                ...
                $product_row = mysqli_fetch_array($run_product);
            ...
            $insert_order = "INSERT INTO user_orders (user_id, amount_due, invoice_number, total_products, order_date, order_status) 
                             VALUES ('$user_id', '$total_price', '$invoice_number', '$total_products', '$order_date', '$order_status')";
            ...
            if ($run_insert) {
                ...
                echo "<script>alert('Order placed successfully! Continue shopping.')</script>";
        ...
        echo "<script>alert('You must be logged in to place an order.')</script>";
